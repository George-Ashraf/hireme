            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <h5 class="text-white mb-4">About HireMe</h5>
                        <p>Connecting job seekers with the right opportunities and helping businesses find top talent.
                        </p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p><i class="fa fa-map-marker-alt me-3"></i> Smart Villages, Cairo-Alex Desert Road, Egypt</p>
                        <p><i class="fa fa-phone-alt me-3"></i> <a href="tel:+201234567890" class="text-white-50">+20
                                123 456 7890</a></p>
                        <p><i class="fa fa-envelope me-3"></i> <a href="mailto:contact@hireme.com"
                                class="text-white-50">contact@hireme.com</a></p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p>Subscribe to our newsletter for the latest job opportunities and hiring trends.</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; 2025 <a class="border-bottom text-white-50" href="#">HireMe</a>. All Rights Reserved.
                        </div>
