        ...
        <div class="job-item p-4 mb-4 border shadow-sm bg-white position-relative">
            <div class="row align-items-center p-4 ">
                ...
                <div class="col-md-3 text-md-end   mt-3  ">
                    ...
                    @if ($post->closed_date < now()) <div
                        class="position-absolute top-0 rounded-sm bg-danger text-white p-2 end-0">
                        Closed
                </div>
                <a class="btn  px-4 py-2 shadow-sm fw-semibold" href="{{ route('post.show', $post->id) }}">Show
                    Details</a>
                @else
