    ...
    <div class="container-xxl bg-white p-0">
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <div class="searchBox mx-auto my-2">
                ...
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                    <!-- Tab navigation -->
                    <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-0 mt-3">
                    ...
                    @if (auth()->user() && auth()->user()->role === 'employer')
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('post.create') }}" class="btn btn-secondary mb-1">Add Job Post</a>
                        </div>
                    @endif
