                    ...
                    <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="3"
                                placeholder="Briefly describe the job">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-danger small mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input min="0" type="number" step="1"
                                ...
                                value="{{ old('salary') }}" placeholder="Enter salary amount">
                            @error('salary')
                                <p class="text-danger small mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('location') is-invalid @enderror"
                                name="location" value="{{ old('location') }}" placeholder="City, State, Country">
                            @error('location')
                                <p class="text-danger small mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label for="responsibility" class="fw-bold">Responsibilities</label>
                            <textarea class="form-control @error('responsibility') is-invalid @enderror" name="responsibility" rows="3"
                                placeholder=" ex.List the key responsibilities and duties for this position">{{ old('responsibility') }}</textarea>
                        ...
                        <div class="form-group mb-3">
                            <label for="qualification" class="fw-bold">Qualifications</label>
                            <textarea class="form-control @error('qualification') is-invalid @enderror" name="qualification" rows="3"
                                placeholder=" ex.List required education, certifications, and experience">{{ old('qualification') }}</textarea>
                            @error('qualification')
                                <p class="text-danger small mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label for="benefits" class="fw-bold">Benefits</label>
                            <textarea class="form-control @error('benefits') is-invalid @enderror" name="benefits" rows="3"
                                placeholder=" ex.List company benefits, perks, and additional compensation">{{ old('benefits') }}</textarea>
                            @error('benefits')
                                <p class="text-danger small mt-1">{{ $message }}</p>
                            @enderror
                        </div>
