                    ...
                    <div class="row gy-5 gx-4">
                        <div class="col-lg-8">
                            <div class="d-flex align-items-center mb-5">
                                <img class="flex-shrink-0 img-fluid border rounded" src="{{ asset('storage/posts/images/' . $post->image) }}" alt="{{ $post->job_title }}" style="width: 80px; height: 80px;">
        ...
        <div class="w-50 ms-5" >
            ...
            <div class="border-b p-3 d-flex flex-col gap-3 my-2">
                <div class="d-flex align-items-center gap-2  pb-2">
                    ...
                    <div>
                    <p>Name: {{$comment->user ? $comment->user->name : "null"}}</p>
