            ...
            <div class="row gy-5 gx-4">
                ...
                <div class="col-lg-4">
                    <div class="bg-light rounded p-5 mb-4 wow slideInUp position-relative " data-wow-delay="0.1s">
                        ...
                        <div class="position-absolute right-0 p-2  text-white bg-green-600 top-0 z-1 opacity-75">
                            {{$post->status}}</div>
                        @elseif ($post->status =="Pending")
                        <div class="position-absolute right-0 p-2  text-white bg-sky-600 top-0 z-1 opacity-75">
                            {{$post->status}}</div>
                    ...
                    <div class="bg-light rounded p-5 wow slideInUp" data-wow-delay="0.1s">
                        <p class="m-0 ">Thank you for considering an opportunity with our company. We appreciate the
                            time and effort you have put into your application. At {{ $post->comapny }}, we value
        ...
        <div class=" rounded my-2">
            ...
            <div class="border-b p-3 d-flex flex-col gap-3 my-2">
                <div class="d-flex align-items-center gap-2  pb-2">
                    <img src="default-image.jpg" alt="User Profile" class="rounded-full border"
