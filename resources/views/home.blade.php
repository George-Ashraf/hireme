                        ...
                        <div class="cat-item rounded p-4">
                            ...
                            <h6 class="mb-3">
                              <a href="{{ route('category.show',$category->id) }}"> {{ $category->name }}</a>
                                ...
                                @can('admin-only')
                                    <a href="{{ route('category.delete', $category->id) }}"> <i class="fa-solid fa-trash text-danger"></i></a>
                                     <a href="{{ route('category.edit', $category->id) }}"> <i class="fa-solid fa-pen-nib text-secondary"></i></a>
                                      @endcan
                                 @endauth
                            </h6>
                                        ...
                                        <div class="row g-4">
                                            <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                                <img class="flex-shrink-0 img-fluid border rounded"
                                                    src="{{ asset(' storage/public' . '/' . $post->image) }}"
